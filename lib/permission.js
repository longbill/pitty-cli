...
const MODE_TOOLS = {
  ...
  'ask':        ['Read', 'Glob', 'Grep', 'WebFetch', 'Write', 'Edit', 'Bash'],
  'audit':      ['Read', 'Glob', 'Grep', 'WebFetch', 'Write', 'Edit', 'Bash'],
  'accept-all': ['Read', 'Glob', 'Grep', 'WebFetch', 'Write', 'Edit', 'Bash'],
};

const VALID_MODES = Object.keys(MODE_TOOLS);

// Tools that require confirmation in ask/accept-all mode
const CONFIRM_TOOLS = ['Write', 'Edit', 'Bash'];
