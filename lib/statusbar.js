...
function createStatusBar(_, opts = {}) {
  ...
  function buildBarText() {
    ...
    const tokens = (displayInTokens > 0 || displayOutTokens > 0) ? ' ↑' + displayInTokens + ' ↓' + displayOutTokens : '';
  ...
  return { startSpinner, stopSpinner, pause, resume, setBar, setTokenInfo, barWriteLine, barFinalize, formatElapsed: (ms) => formatElapsedStr(ms, _) };
}
