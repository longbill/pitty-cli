...
const tool = {
  name: 'Write',
  description: 'Write content to a file. Creates the file if it does not exist, or overwrites if it does. Only overwrites existing files that have been read first and have not been externally modified.',
  inputSchema: {
    type: 'object',
    properties: {
