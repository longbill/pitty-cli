...
// Track actual chars/token ratio from real usage data for streaming estimates
...
function repairMessages(msgs) {
  ...
  // Single forward pass: find the first assistant whose tool calls are incomplete
  ...
  // Trim trailing orphaned tool messages
